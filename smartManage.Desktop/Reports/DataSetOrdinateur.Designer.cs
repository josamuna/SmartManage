...
namespace smartManage.Desktop.Reports {
    ...
    [global::System.Xml.Serialization.XmlRootAttribute("DataSetOrdinateur")]
    [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")]
    public partial class DataSetOrdinateur : global::System.Data.DataSet {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        protected DataSetOrdinateur(global::System.Runtime.Serialization.SerializationInfo info, global::System.Runtime.Serialization.StreamingContext context) : 
        ...
        public override global::System.Data.DataSet Clone() {
            DataSetOrdinateur cln = ((DataSetOrdinateur)(base.Clone()));
            cln.InitVars();
        ...
        private void InitClass() {
            this.DataSetName = "DataSetOrdinateur";
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/DataSetOrdinateur.xsd";
        ...
        public static global::System.Xml.Schema.XmlSchemaComplexType GetTypedDataSetSchema(global::System.Xml.Schema.XmlSchemaSet xs) {
            DataSetOrdinateur ds = new DataSetOrdinateur();
...
namespace smartManage.Desktop.Reports.DataSetOrdinateurTableAdapters {
    ...
    public partial class DataTable1TableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "select materiel.id,materiel.code_str as \'Code\',categorie_materiel.designation as " +
                ...
                "atible_wifi as \'SupportWifi\'\r\n\r\nfrom materiel \r\nleft outer join garantie on gara" +
                "ntie.id=materiel.id_garantie\r\nleft outer join categorie_materiel on categorie_ma" +
                "teriel.id=materiel.id_categorie_materiel\r\ninner join compte on compte.id=materie" +
                "l.id_compte\r\ninner join marque on marque.id=materiel.id_marque\r\ninner join model" +
                "e on modele.id=materiel.id_modele\r\ninner join couleur on couleur.id=materiel.id_" +
                "couleur\r\ninner join poids on poids.id=materiel.id_poids\r\ninner join etat_materie" +
                "l on etat_materiel.id=materiel.id_etat_materiel\r\nleft outer join type_ordinateur" +
                " on type_ordinateur.id=materiel.id_type_ordinateur\r\nleft outer join type_clavier" +
                " on type_clavier.id=materiel.id_type_clavier\r\nleft outer join OS on OS.id=materi" +
                "el.id_OS\r\nleft outer join ram on ram.id=materiel.id_ram\r\nleft outer join process" +
                "eur on processeur.id=materiel.id_processeur\r\nleft outer join nombre_coeur_proces" +
                "seur on nombre_coeur_processeur.id=materiel.id_nombre_coeur_processeur\r\nleft out" +
                "er join type_hdd on type_hdd.id=materiel.id_type_hdd\r\nleft outer join nombre_hdd" +
                " on nombre_hdd.id=materiel.id_nombre_hdd\r\nleft outer join capacite_hdd on capaci" +
                "te_hdd.id=materiel.id_capacite_hdd\r\nleft outer join taille_ecran on taille_ecran" +
                ".id=materiel.id_taille_ecran\r\nleft outer join usb2 on usb2.id=materiel.id_usb2\r\n" +
                "left outer join usb3 on usb3.id=materiel.id_usb3\r\nleft outer join hdmi on hdmi.i" +
                "d=materiel.id_hdmi\r\nleft outer join vga on vga.id=materiel.id_vga\r\nleft outer jo" +
                "in tension_batterie on tension_batterie.id=materiel.id_tension_batterie\r\nleft ou" +
                "ter join tension_adaptateur on tension_adaptateur.id=materiel.id_tension_adaptat" +
                "eur\r\nleft outer join puissance_adaptateur on puissance_adaptateur.id=materiel.id" +
                "_puissance_adaptateur\r\nleft outer join intensite_adaptateur on intensite_adaptat" +
                "eur.id=materiel.id_intensite_adaptateur\r\n\r\n--Printer\r\nleft outer join type_impri" +
                "mante on type_imprimante.id=materiel.id_type_imprimante\r\nleft outer join puissan" +
                "ce on puissance.id=materiel.id_puissance\r\nleft outer join intensite on intensite" +
                ".id=materiel.id_intensite\r\nleft outer join page_par_minute on page_par_minute.id" +
                "=materiel.id_page_par_minute\r\n\r\n--Amplificateur\r\nleft outer join type_amplificat" +
                "eur on type_amplificateur.id=materiel.id_type_amplificateur\r\nleft outer join ten" +
                "sion_alimentation on tension_alimentation.id=materiel.id_tension_alimentation\r\nl" +
                "eft outer join usb on usb.id=materiel.id_usb\r\nleft outer join memoire on memoire" +
                ".id=materiel.id_memoire\r\nleft outer join sorties_audio on sorties_audio.id=mater" +
                "iel.id_sorties_audio\r\nleft outer join microphone on microphone.id=materiel.id_mi" +
                "crophone\r\nleft outer join gain on gain.id=materiel.id_gain\r\n\r\n--Routeur_AP\r\nleft" +
                " outer join type_routeur_AP on type_routeur_AP.id=materiel.id_type_routeur_AP\r\nl" +
                "eft outer join gbe on gbe.id=materiel.id_gbe\r\nleft outer join fe on fe.id=materi" +
                "el.id_fe\r\nleft outer join fo on fo.id=materiel.id_fo\r\nleft outer join serial on " +
                "serial.id=materiel.id_serial\r\nleft outer join default_pwd on default_pwd.id=mate" +
                "riel.id_default_pwd\r\nleft outer join default_ip on default_ip.id=materiel.id_def" +
                "ault_ip\r\nleft outer join console on console.id=materiel.id_console\r\nleft outer j" +
                "oin auxiliaire on auxiliaire.id=materiel.id_auxiliaire\r\nleft outer join version_" +
                "ios on version_ios.id=materiel.id_version_ios\r\n--capable_usb\r\n\r\n--AccessPoint\r\nl" +
                "eft outer join type_AP on type_AP.id=materiel.id_type_AP\r\nleft outer join portee" +
                " on portee.id=materiel.id_portee\r\n\r\n--Switch\r\nleft outer join type_switch on typ" +
        ...
        public virtual int Fill(DataSetOrdinateur.DataTable1DataTable dataTable) {
        ...
        public virtual DataSetOrdinateur.DataTable1DataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DataSetOrdinateur.DataTable1DataTable dataTable = new DataSetOrdinateur.DataTable1DataTable();
    ...
    public partial class TableAdapterManager : global::System.ComponentModel.Component {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        private int UpdateUpdatedRows(DataSetOrdinateur dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            return result;
        }
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        private int UpdateInsertedRows(DataSetOrdinateur dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            return result;
        }
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        private int UpdateDeletedRows(DataSetOrdinateur dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows) {
            int result = 0;
            return result;
        }
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        public virtual int UpdateAll(DataSetOrdinateur dataSet) {
            if ((dataSet == null)) {

...
namespace smartManage.Desktop
{
    public partial class frmAC : Form
    {
        ...
        private clsAC materiel = new clsAC();
        int? newID = null;
        ...
        private void BindingCls()
        {
            ...
            SetBindingControls(txtCodeString, "Text", materiel, "Code_str");
        ...
        private void BindingList()
        {
            ...
            SetBindingControls(txtCodeString, "Text", bdsrc, "Code_str");
        ...
        {
            bdsrc.DataSource = clsMetier.GetInstance().getAllClsAC();
        ...
        private void New()
        {
            ...
            //Set the new ID
            if (newID == null)
                newID = clsMetier.GetInstance().GenerateLastID("AC");
        ...
        private void Search(string criteria)
        {
            ...
            {
                List<clsAC> lstItemSearch = new List<clsAC>();
                lstItemSearch = clsMetier.GetInstance().getAllClsAC(criteria);
        ...
        {
            ((clsAC)bdsrc.Current).User_modified = smartManage.Desktop.Properties.Settings.Default.UserConnected;
            ((clsAC)bdsrc.Current).Date_modified = DateTime.Now;

            int record = materiel.update(((clsAC)bdsrc.Current));
        ...
        private void Delete()
        {
            if (blnModifie)
            {
                ...
                {
                    record = materiel.delete(((clsAC)bdsrc.Current));

        ...
        private void CallActualiseComboBoxModification(string threadName)
        {
            ...
            try
            {
                if (!string.IsNullOrEmpty(Properties.Settings.Default.strFormModifieSubForm))
                {
                    ...
                    else if (Properties.Settings.Default.strFormModifieSubForm.Equals(FormActualisation.frmTypeAccessPoint.ToString()))
                    {
                        cboTypeAccessPoint.DataSource = clsMetier.GetInstance().getAllClstype_AP();
                        this.setMembersallcbo(cboTypeAccessPoint, "Designation", "Id");
                    }
                    ...
                    else if (Properties.Settings.Default.strFormModifieSubForm.Equals(FormActualisation.frmPortee.ToString()))
                    {
                        cboPortee.DataSource = clsMetier.GetInstance().getAllClsportee();
                        this.setMembersallcbo(cboPortee, "Valeur", "Id");
                    }

...
namespace smartManage.Desktop
{
    public partial class frmAdresse : Form
    {
        ...
        private clsadresse materiel = new clsadresse();
        int? newID = null;
        ...
        {
            bdsrc.DataSource = clsMetier.GetInstance().getAllClsadresse(smartManage.Desktop.Properties.Settings.Default.IdentifiantPersonne);
        ...
        private void New()
        {
            ...
            //Set the new ID
            if (newID == null)
                newID = clsMetier.GetInstance().GenerateLastID("adresse");
        ...
        private void Search(string criteria)
        {
            ...
            {
                List<clsadresse> lstItemSearch = new List<clsadresse>();
                lstItemSearch = clsMetier.GetInstance().getAllClsadresse(criteria, smartManage.Desktop.Properties.Settings.Default.IdentifiantPersonne);
        ...
        {
            ((clsadresse)bdsrc.Current).User_modified = smartManage.Desktop.Properties.Settings.Default.UserConnected;
            ((clsadresse)bdsrc.Current).Date_modified = DateTime.Now;

            int record = materiel.update(((clsadresse)bdsrc.Current));
        ...
        private void Delete()
        {
            if (blnModifie)
            {
                ...
                {
                    record = materiel.delete(((clsadresse)bdsrc.Current));

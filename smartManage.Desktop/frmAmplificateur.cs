        ...
        private void CallActualiseComboBoxModification(string threadName)
        {
            ...
            try
            {
                if (!string.IsNullOrEmpty(smartManage.Desktop.Properties.Settings.Default.strFormModifieSubForm))
                {
                    ...
                    else if (smartManage.Desktop.Properties.Settings.Default.strFormModifieSubForm.Equals(FormActualisation.frmTypeAmplificateur.ToString()))
                    {
                        cboTypeAmplificateur.DataSource = clsMetier.GetInstance().getAllClstype_amplificateur();
                        this.setMembersallcbo(cboTypeAmplificateur, "Designation", "Id");
                    }
                    ...
                    else if (smartManage.Desktop.Properties.Settings.Default.strFormModifieSubForm.Equals(FormActualisation.frmNbrUSB.ToString()))
                    {
                        cboNbrUSB.DataSource = clsMetier.GetInstance().getAllClsusb();
                        this.setMembersallcbo(cboNbrUSB, "Valeur", "Id");
                    }
                    ...
                    else if (smartManage.Desktop.Properties.Settings.Default.strFormModifieSubForm.Equals(FormActualisation.frmNbrMemoire.ToString()))
                    {
                        cboNbrMemoire.DataSource = clsMetier.GetInstance().getAllClsmemoire();
                        this.setMembersallcbo(cboNbrMemoire, "Valeur", "Id");
                    }
                    else if (smartManage.Desktop.Properties.Settings.Default.strFormModifieSubForm.Equals(FormActualisation.frmNbrSortieAudio.ToString()))
                    {
                        cboNbrSortiesAudio.DataSource = clsMetier.GetInstance().getAllClssorties_audio();
                        this.setMembersallcbo(cboNbrSortiesAudio, "Valeur", "Id");
                    }
                    else if (smartManage.Desktop.Properties.Settings.Default.strFormModifieSubForm.Equals(FormActualisation.frmNbrMicrophone.ToString()))
                    {
                        cboNbrMicrophone.DataSource = clsMetier.GetInstance().getAllClsmicrophone();
                        this.setMembersallcbo(cboNbrMicrophone, "Valeur", "Id");
                    }
                    else if (smartManage.Desktop.Properties.Settings.Default.strFormModifieSubForm.Equals(FormActualisation.frmGain.ToString()))
                    {
                        cboGain.DataSource = clsMetier.GetInstance().getAllClsgain();
                        this.setMembersallcbo(cboGain, "Valeur", "Id");
                    }                   

...
{
    public partial class frmArchitectureOS : Form
    {
        BindingSource bdsrc = new BindingSource();
        bool blnModifie = false;
        private clsarchitecture_OS materiel = new clsarchitecture_OS();
        int? newID = null;

        public frmArchitectureOS()
        {
            InitializeComponent();
        }
        ...
        {
            bdsrc.DataSource = clsMetier.GetInstance().getAllClsarchitecture_OS();
        ...
        private void New()
        {
            ...
            materiel = new clsarchitecture_OS();
            ...
            //Set the new ID
            if (newID == null)
                newID = clsMetier.GetInstance().GenerateLastID("architecture_OS");
        ...
        private void Search(string criteria)
        {
            ...
            {
                List<clsarchitecture_OS> lstItemSearch = new List<clsarchitecture_OS>();
                lstItemSearch = clsMetier.GetInstance().getAllClsarchitecture_OS(criteria);
        ...
        {
            ((clsarchitecture_OS)bdsrc.Current).User_modified = smartManage.Desktop.Properties.Settings.Default.UserConnected;
            ((clsarchitecture_OS)bdsrc.Current).Date_modified = DateTime.Now;

            int record = materiel.update(((clsarchitecture_OS)bdsrc.Current));
        ...
        private void Delete()
        {
            if (blnModifie)
            {
                ...
                {
                    record = materiel.delete(((clsarchitecture_OS)bdsrc.Current));
                    ...
                    newID = null;
                    smartManage.Desktop.Properties.Settings.Default.strFormModifieOS = this.Name;
                    RefreshData();
                }
                else

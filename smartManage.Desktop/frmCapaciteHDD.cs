...
{
    public partial class frmCapaciteHDD : Form
    {
        BindingSource bdsrc = new BindingSource();
        bool blnModifie = false;
        private clscapacite_hdd materiel = new clscapacite_hdd();
        int? newID = null;

        public frmCapaciteHDD()
        {
            InitializeComponent();
        }
        ...
        {
            bdsrc.DataSource = clsMetier.GetInstance().getAllClscapacite_hdd();
        ...
        private void New()
        {
            ...
            //Set the new ID
            if (newID == null)
                newID = clsMetier.GetInstance().GenerateLastID("capacite_hdd");
        ...
        private void Search(string criteria)
        {
            ...
            {
                List<clscapacite_hdd> lstItemSearch = new List<clscapacite_hdd>();
                lstItemSearch = clsMetier.GetInstance().getAllClscapacite_hdd(criteria);
        ...
        {
            ((clscapacite_hdd)bdsrc.Current).User_modified = smartManage.Desktop.Properties.Settings.Default.UserConnected;
            ((clscapacite_hdd)bdsrc.Current).Date_modified = DateTime.Now;

            int record = materiel.update(((clscapacite_hdd)bdsrc.Current));
        ...
        private void Delete()
        {
            if (blnModifie)
            {
                ...
                {
                    record = materiel.delete(((clscapacite_hdd)bdsrc.Current));

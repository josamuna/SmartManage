...
{
    public partial class frmCouleur : Form
    {
        BindingSource bdsrc = new BindingSource();
        bool blnModifie = false;
        private clscouleur materiel = new clscouleur();
        int? newID = null;
        ...
        {
            bdsrc.DataSource = clsMetier.GetInstance().getAllClscouleur();
        ...
        private void New()
        {
            ...
            //Set the new ID
            if (newID == null)
                newID = clsMetier.GetInstance().GenerateLastID("couleur");
        ...
        private void Search(string criteria)
        {
            ...
            {
                List<clscouleur> lstItemSearch = new List<clscouleur>();
                lstItemSearch = clsMetier.GetInstance().getAllClscouleur(criteria);
        ...
        {
            ((clscouleur)bdsrc.Current).User_modified = smartManage.Desktop.Properties.Settings.Default.UserConnected;
            ((clscouleur)bdsrc.Current).Date_modified = DateTime.Now;

            int record = materiel.update(((clscouleur)bdsrc.Current));
        ...
        private void Delete()
        {
            if (blnModifie)
            {
                ...
                {
                    record = materiel.delete(((clscouleur)bdsrc.Current));
        ...
        private void frmCouleur_Load(object sender, EventArgs e)
        {

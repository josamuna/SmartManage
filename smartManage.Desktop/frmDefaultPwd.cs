...
{
    public partial class frmDefaultPwd : Form
    {
        BindingSource bdsrc = new BindingSource();
        bool blnModifie = false;
        private clsdefault_pwd materiel = new clsdefault_pwd();
        int? newID = null;

        public frmDefaultPwd()
        {
            InitializeComponent();
        }
        ...
        {
            bdsrc.DataSource = clsMetier.GetInstance().getAllClsdefault_pwd();
        ...
        private void New()
        {
            ...
            //Set the new ID
            if (newID == null)
                newID = clsMetier.GetInstance().GenerateLastID("default_pwd");
        ...
        private void Search(string criteria)
        {
            ...
            {
                List<clsdefault_pwd> lstItemSearch = new List<clsdefault_pwd>();
                lstItemSearch = clsMetier.GetInstance().getAllClsdefault_pwd(criteria);
        ...
        {
            ((clsdefault_pwd)bdsrc.Current).User_modified = smartManage.Desktop.Properties.Settings.Default.UserConnected;
            ((clsdefault_pwd)bdsrc.Current).Date_modified = DateTime.Now;

            int record = materiel.update(((clsdefault_pwd)bdsrc.Current));
        ...
        private void Delete()
        {
            if (blnModifie)
            {
                ...
                {
                    record = materiel.delete(((clsdefault_pwd)bdsrc.Current));
        ...
        private void frmDefaultPwd_Load(object sender, EventArgs e)
        {

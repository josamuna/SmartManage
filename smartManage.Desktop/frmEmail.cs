...
namespace smartManage.Desktop
{
    public partial class frmEmail : Form
    {
        ...
        private clsemail materiel = new clsemail();
        int? newID = null;
        ...
        {
            bdsrc.DataSource = clsMetier.GetInstance().getAllClsemail(smartManage.Desktop.Properties.Settings.Default.IdentifiantPersonne);
        ...
        private void New()
        {
            ...
            //Set the new ID
            if (newID == null)
                newID = clsMetier.GetInstance().GenerateLastID("email");
        ...
        private void Search(string criteria)
        {
            ...
            {
                List<clsemail> lstItemSearch = new List<clsemail>();
                lstItemSearch = clsMetier.GetInstance().getAllClsemail(criteria, smartManage.Desktop.Properties.Settings.Default.IdentifiantPersonne);
        ...
        {
            ((clsemail)bdsrc.Current).User_modified = smartManage.Desktop.Properties.Settings.Default.UserConnected;
            ((clsemail)bdsrc.Current).Date_modified = DateTime.Now;

            int record = materiel.update(((clsemail)bdsrc.Current));
        ...
        private void Delete()
        {
            if (blnModifie)
            {
                ...
                {
                    record = materiel.delete(((clsemail)bdsrc.Current));

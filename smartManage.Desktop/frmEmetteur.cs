...
{
    public partial class frmEmetteur : Form, ICRUDGeneral, ICallMainForm
    {
        ...
        private void LoadMiddleCombo(string threadName)
        {
            try
            {
                ...
                cboNbrAntennes.DataSource = clsMetier.GetInstance().getAllClsantenne();
                this.setMembersallcbo(cboNbrAntennes, "Valeur", "Id");
                ...
                this.setMembersallcbo(cboFrequence, "Designation", "Id");

                List<ComboBox> lstCombo = new List<ComboBox>() { cboNbrAntennes, cboTensionAlimentation, cboPuissance, cboIntensite, cboFrequence };
        ...
        private void LoadDataGrid(string threadName)
        {
            try
            {
                ...
                bdsrc.DataSource = clsMetier.GetInstance().getAllClsmateriel_Emetteur();
        ...
        private void GenerateQrCode(string threadName)
        {
            try
            {
                ...
                txtLabel.Text = clsMetier.GetInstance().GenerateLabelMateriel(Convert.ToInt32(txtId.Text), "ILEm");
        ...
        private void CallActualiseComboBoxModification(string threadName)
        {
            ...
            try
            {
                if (!string.IsNullOrEmpty(Properties.Settings.Default.strFormModifieSubForm))
                {
                    ...
                    else if (Properties.Settings.Default.strFormModifieSubForm.Equals(FormActualisation.frmNbrAntenne.ToString()))
                    {
                        cboNbrAntennes.DataSource = clsMetier.GetInstance().getAllClsantenne();
                        this.setMembersallcbo(cboNbrAntennes, "Valeur", "Id");
                    }
                    ...
                    else if (Properties.Settings.Default.strFormModifieSubForm.Equals(FormActualisation.frmFrequence.ToString()))
                    {
                        cboFrequence.DataSource = clsMetier.GetInstance().getAllClsfrequence();
                        this.setMembersallcbo(cboFrequence, "Valeur", "Id");
                    }
                }
        ...
        private void BindingCls()
        {
            ...
            //Partie pour Emetteur
            SetBindingControls(cboNbrAntennes, "SelectedValue", materiel, "Id_antenne");
            ...
            SetBindingControls(cboFrequence, "SelectedValue", materiel, "Id_frequence");                   
        }
        ...
        private void BindingList()
        {
            ...
            SetBindingControls(cboNbrAntennes, "SelectedValue", bdsrc, "Id_antenne");
            ...
            SetBindingControls(cboFrequence, "SelectedValue", bdsrc, "Id_frequence");
        }
        #endregion
        ...
        public void New()
        {
            try
            {
                ...
                cboCatMateriel.Text = clsMetier.GetInstance().getClscategorie_materiel("4").Designation.ToString();
            }
            catch (ArgumentException ex)
            {
        ...
        private void cboNbrAntennes_DropDown(object sender, EventArgs e)
        {
            DoActualiseDropDown();
        }

        private void lblAddNbrAntennes_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            frmNbrAntenne frm = new frmNbrAntenne();
            frm.Icon = this.Icon;
            frm.ShowDialog();
        }

        private void cboFrequence_DropDown(object sender, EventArgs e)
        {
            DoActualiseDropDown();
        }

        private void lblAddFrequence_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            frmFrequence frm = new frmFrequence();
            frm.Icon = this.Icon;
            frm.ShowDialog();
        }

        private void frmEmetteur_Load(object sender, EventArgs e)
        {
            cmdArchiver.Enabled = false;
        ...
        private void frmEmetteur_FormClosed(object sender, FormClosedEventArgs e)
        {
        ...
        private void frmEmetteur_Activated(object sender, EventArgs e)
        {
            Principal.SetValuesLabel(Properties.Settings.Default.UserConnected, "Gestion des emetteurs");

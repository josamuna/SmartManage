        ...
        private void CallActualiseComboBoxModification(string threadName)
        {
            ...
            try
            {
                if (!string.IsNullOrEmpty(smartManage.Desktop.Properties.Settings.Default.strFormModifieSubForm))
                {
                    ...
                    else if (smartManage.Desktop.Properties.Settings.Default.strFormModifieSubForm.Equals(FormActualisation.frmNbrAntenne.ToString()))
                    {
                        cboNbrAntennes.DataSource = clsMetier.GetInstance().getAllClsantenne();
                        this.setMembersallcbo(cboNbrAntennes, "Valeur", "Id");
                    }
                    ...
                    else if (smartManage.Desktop.Properties.Settings.Default.strFormModifieSubForm.Equals(FormActualisation.frmFrequence.ToString()))
                    {
                        cboFrequence.DataSource = clsMetier.GetInstance().getAllClsfrequence();

...
{
    public partial class frmEtatMateriel : Form
    {
        BindingSource bdsrc = new BindingSource();
        bool blnModifie = false;
        private clsetat_materiel materiel = new clsetat_materiel();
        int? newID = null;

        public frmEtatMateriel()
        {
            InitializeComponent();
        }
        ...
        {
            bdsrc.DataSource = clsMetier.GetInstance().getAllClsetat_materiel();
        ...
        private void New()
        {
            ...
            //Set the new ID
            if (newID == null)
                newID = clsMetier.GetInstance().GenerateLastID("etat_materiel");
        ...
        private void Search(string criteria)
        {
            ...
            {
                List<clsetat_materiel> lstItemSearch = new List<clsetat_materiel>();
                lstItemSearch = clsMetier.GetInstance().getAllClsetat_materiel(criteria);
        ...
        {
            ((clsetat_materiel)bdsrc.Current).User_modified = smartManage.Desktop.Properties.Settings.Default.UserConnected;
            ((clsetat_materiel)bdsrc.Current).Date_modified = DateTime.Now;

            int record = materiel.update(((clsetat_materiel)bdsrc.Current));
        ...
        private void Delete()
        {
            if (blnModifie)
            {
                ...
                {
                    record = materiel.delete(((clsetat_materiel)bdsrc.Current));
        ...
        private void frmEtatMateriel_Load(object sender, EventArgs e)
        {

...
namespace smartManage.Desktop
{
    public partial class frmFonction : Form
    {
        ...
        private clsfonction materiel = new clsfonction();
        int? newID = null;
        ...
        {
            bdsrc.DataSource = clsMetier.GetInstance().getAllClsfonction();
        ...
        private void New()
        {
            ...
            //Set the new ID
            if (newID == null)
                newID = clsMetier.GetInstance().GenerateLastID("fonction");
        ...
        private void Search(string criteria)
        {
            ...
            {
                List<clsfonction> lstItemSearch = new List<clsfonction>();
                lstItemSearch = clsMetier.GetInstance().getAllClsfonction(criteria);
        ...
        {
            ((clsfonction)bdsrc.Current).User_modified = smartManage.Desktop.Properties.Settings.Default.UserConnected;
            ((clsfonction)bdsrc.Current).Date_modified = DateTime.Now;

            int record = materiel.update(((clsfonction)bdsrc.Current));
        ...
        private void Delete()
        {
            if (blnModifie)
            {
                ...
                {
                    record = materiel.delete(((clsfonction)bdsrc.Current));

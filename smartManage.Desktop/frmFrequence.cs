...
{
    public partial class frmFrequence : Form
    {
        BindingSource bdsrc = new BindingSource();
        bool blnModifie = false;
        private clsfrequence materiel = new clsfrequence();
        int? newID = null;
        ...
        {
            bdsrc.DataSource = clsMetier.GetInstance().getAllClsfrequence();
        ...
        private void New()
        {
            ...
            //Set the new ID
            if (newID == null)
                newID = clsMetier.GetInstance().GenerateLastID("frequence");
        ...
        private void Search(string criteria)
        {
            ...
            {
                List<clsfrequence> lstItemSearch = new List<clsfrequence>();
                lstItemSearch = clsMetier.GetInstance().getAllClsfrequence(criteria);
        ...
        {
            ((clsfrequence)bdsrc.Current).User_modified = smartManage.Desktop.Properties.Settings.Default.UserConnected;
            ((clsfrequence)bdsrc.Current).Date_modified = DateTime.Now;

            int record = materiel.update(((clsfrequence)bdsrc.Current));
        ...
        private void Delete()
        {
            if (blnModifie)
            {
                ...
                {
                    record = materiel.delete(((clsfrequence)bdsrc.Current));
        ...
        private void frmFrequence_Load(object sender, EventArgs e)
        {

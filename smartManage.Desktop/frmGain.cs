...
namespace smartManage.Desktop
{
    public partial class frmGain : Form
    {
        ...
        private clsgain materiel = new clsgain();
        int? newID = null;
        ...
        {
            bdsrc.DataSource = clsMetier.GetInstance().getAllClsgain();
        ...
        private void New()
        {
            ...
            //Set the new ID
            if (newID == null)
                newID = clsMetier.GetInstance().GenerateLastID("gain");
        ...
        private void Search(string criteria)
        {
            ...
            {
                List<clsgain> lstItemSearch = new List<clsgain>();
                lstItemSearch = clsMetier.GetInstance().getAllClsgain(criteria);
        ...
        {
            ((clsgain)bdsrc.Current).User_modified = smartManage.Desktop.Properties.Settings.Default.UserConnected;
            ((clsgain)bdsrc.Current).Date_modified = DateTime.Now;

            int record = materiel.update(((clsgain)bdsrc.Current));
        ...
        private void Delete()
        {
            if (blnModifie)
            {
                ...
                {
                    record = materiel.delete(((clsgain)bdsrc.Current));

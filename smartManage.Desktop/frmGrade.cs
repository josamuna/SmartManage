...
namespace smartManage.Desktop
{
    public partial class frmGrade : Form
    {
        ...
        private clsgrade materiel = new clsgrade();
        int? newID = null;
        ...
        {
            bdsrc.DataSource = clsMetier.GetInstance().getAllClsgrade();
        ...
        private void New()
        {
            ...
            //Set the new ID
            if (newID == null)
                newID = clsMetier.GetInstance().GenerateLastID("grade");
        ...
        private void Search(string criteria)
        {
            ...
            {
                List<clsgrade> lstItemSearch = new List<clsgrade>();
                lstItemSearch = clsMetier.GetInstance().getAllClsgrade(criteria);
        ...
        {
            ((clsgrade)bdsrc.Current).User_modified = smartManage.Desktop.Properties.Settings.Default.UserConnected;
            ((clsgrade)bdsrc.Current).Date_modified = DateTime.Now;

            int record = materiel.update(((clsgrade)bdsrc.Current));
        ...
        private void Delete()
        {
            if (blnModifie)
            {
                ...
                {
                    record = materiel.delete(((clsgrade)bdsrc.Current));

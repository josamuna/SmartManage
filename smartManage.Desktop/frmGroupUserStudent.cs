...
{
    public partial class frmGroupUserStudent : Form
    {
        ...
        {
            bdsrc.DataSource = clsMetier2.GetInstance().getAllClsradgroupcheck();
        ...
        private void New()
        {
            ...
            //Set the new ID
            if (newID == null)
                newID = clsMetier2.GetInstance().GenerateLastID("radgroupcheck");
        ...
        private void Search(string criteria)
        {
            ...
            else
            {
                ...
                lstItemSearch = clsMetier2.GetInstance().getAllClsradgroupcheck(criteria);
        ...
        private void frmGroupUserStudent_Load(object sender, EventArgs e)
        {

    ...
    public partial class frmImprimante : Form, ICRUDGeneral, ICallMainForm
    {
        ...
        private void LoadMiddleCombo(string threadName)
        {
            try
            {
                ...
                cboTypeImprimante.DataSource = clsMetier.GetInstance().getAllClstype_imprimante();
                this.setMembersallcbo(cboTypeImprimante, "Designation", "Id");
                ...
                this.setMembersallcbo(cboPPM, "Valeur", "Id");

                List<ComboBox> lstCombo = new List<ComboBox>() { cboTypeImprimante, cboTensionAlimentation, cboPuissance, cboIntensite, cboPPM };
        ...
        private void LoadDataGrid(string threadName)
        {
            try
            {
                ...
                bdsrc.DataSource = clsMetier.GetInstance().getAllClsmateriel_Imprimante();
        ...
        private void GenerateQrCode(string threadName)
        {
            try
            {
                ...
                txtLabel.Text = clsMetier.GetInstance().GenerateLabelMateriel(Convert.ToInt32(txtId.Text), "ILImp");
        ...
        private void CallActualiseComboBoxModification(string threadName)
        {
            ...
            try
            {
                if (!string.IsNullOrEmpty(Properties.Settings.Default.strFormModifieSubForm))
                {
                    ...
                    else if (Properties.Settings.Default.strFormModifieSubForm.Equals(FormActualisation.frmTypeImprimante.ToString()))
                    {
                        cboTypeImprimante.DataSource = clsMetier.GetInstance().getAllClstype_imprimante();
                        this.setMembersallcbo(cboTypeImprimante, "Designation", "Id");
                    }
                    ...
                    else if (Properties.Settings.Default.strFormModifieSubForm.Equals(FormActualisation.frmPageParMinute.ToString()))
                    {
                        cboPPM.DataSource = clsMetier.GetInstance().getAllClspage_par_minute();
                        this.setMembersallcbo(cboPPM, "Valeur", "Id");
                    }
        ...
        private void BindingCls()
        {
            ...
            //Partie pour Imprimante
            SetBindingControls(cboTypeImprimante, "SelectedValue", materiel, "Id_type_imprimante");
            ...
            SetBindingControls(cboPPM, "SelectedValue", materiel, "Id_page_par_minute");                   
        }
        ...
        private void BindingList()
        {
            ...
            //Partie pour Imprimante
            SetBindingControls(cboTypeImprimante, "SelectedValue", bdsrc, "Id_type_imprimante");
            ...
            SetBindingControls(cboPPM, "SelectedValue", bdsrc, "Id_page_par_minute");
        }
        #endregion
        ...
        public void New()
        {
            try
            {
                ...
                cboCatMateriel.Text = clsMetier.GetInstance().getClscategorie_materiel("3").Designation.ToString();
            }
            catch (ArgumentException ex)
            {
        ...
        private void cboTypeImprimante_DropDown(object sender, EventArgs e)
        {
            DoActualiseDropDown();
        }
        ...
        private void cboPPM_DropDown(object sender, EventArgs e)
        {
            DoActualiseDropDown();
        }
        ...
        {
            Principal.SetValuesLabel(Properties.Settings.Default.UserConnected, "Gestion des imprimantes");
        ...
        private void lblAddPrinter_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
        ...
        private void lblAddPPM_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            frmPageParMinute frm = new frmPageParMinute();
            frm.Icon = this.Icon;
            frm.ShowDialog();
        }

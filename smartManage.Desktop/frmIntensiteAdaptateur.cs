...
{
    public partial class frmIntensiteAdaptateur : Form
    {
        BindingSource bdsrc = new BindingSource();
        bool blnModifie = false;
        private clsintensite_adaptateur materiel = new clsintensite_adaptateur();
        int? newID = null;

        public frmIntensiteAdaptateur()
        {
            InitializeComponent();
        }
        ...
        {
            bdsrc.DataSource = clsMetier.GetInstance().getAllClsintensite_adaptateur();
        ...
        private void New()
        {
            ...
            materiel = new clsintensite_adaptateur();
            ...
            //Set the new ID
            if (newID == null)
                newID = clsMetier.GetInstance().GenerateLastID("intensite_adaptateur");
        ...
        private void Search(string criteria)
        {
            ...
            {
                List<clsintensite_adaptateur> lstItemSearch = new List<clsintensite_adaptateur>();
                lstItemSearch = clsMetier.GetInstance().getAllClsintensite_adaptateur(criteria);
        ...
        {
            ((clsintensite_adaptateur)bdsrc.Current).User_modified = smartManage.Desktop.Properties.Settings.Default.UserConnected;
            ((clsintensite_adaptateur)bdsrc.Current).Date_modified = DateTime.Now;

            int record = materiel.update(((clsintensite_adaptateur)bdsrc.Current));
        ...
        private void Delete()
        {
            if (blnModifie)
            {
                ...
                {
                    record = materiel.delete(((clsintensite_adaptateur)bdsrc.Current));
        ...
        private void frmIntensiteAdaptateur_Load(object sender, EventArgs e)
        {

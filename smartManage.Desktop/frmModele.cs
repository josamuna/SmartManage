...
namespace smartManage.Desktop
{
    public partial class frmModele : Form
    {
        ...
        private clsmodele materiel = new clsmodele();
        int? newID = null;
        ...
        {
            bdsrc.DataSource = clsMetier.GetInstance().getAllClsmodele();
        ...
        private void New()
        {
            ...
            //Set the new ID
            if (newID == null)
                newID = clsMetier.GetInstance().GenerateLastID("modele");
        ...
        private void Search(string criteria)
        {
            ...
            {
                List<clsmodele> lstItemSearch = new List<clsmodele>();
                lstItemSearch = clsMetier.GetInstance().getAllClsmodele(criteria);
        ...
        {
            ((clsmodele)bdsrc.Current).User_modified = smartManage.Desktop.Properties.Settings.Default.UserConnected;
            ((clsmodele)bdsrc.Current).Date_modified = DateTime.Now;

            int record = materiel.update(((clsmodele)bdsrc.Current));
        ...
        private void Delete()
        {
            if (blnModifie)
            {
                ...
                {
                    record = materiel.delete(((clsmodele)bdsrc.Current));

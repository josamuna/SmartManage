...
{
    public partial class frmNbrAntenne : Form
    {
        BindingSource bdsrc = new BindingSource();
        bool blnModifie = false;
        private clsantenne materiel = new clsantenne();
        int? newID = null;

        public frmNbrAntenne()
        {
            InitializeComponent();
        }
        ...
        {
            bdsrc.DataSource = clsMetier.GetInstance().getAllClsantenne();
        ...
        private void New()
        {
            ...
            //Set the new ID
            if (newID == null)
                newID = clsMetier.GetInstance().GenerateLastID("antenne");
        ...
        private void Search(string criteria)
        {
            ...
            {
                List<clsantenne> lstItemSearch = new List<clsantenne>();
                lstItemSearch = clsMetier.GetInstance().getAllClsantenne(criteria);
        ...
        {
            ((clsantenne)bdsrc.Current).User_modified = smartManage.Desktop.Properties.Settings.Default.UserConnected;
            ((clsantenne)bdsrc.Current).Date_modified = DateTime.Now;

            int record = materiel.update(((clsantenne)bdsrc.Current));
        ...
        private void Delete()
        {
            if (blnModifie)
            {
                ...
                {
                    record = materiel.delete(((clsantenne)bdsrc.Current));
        ...
        private void frmNbrAntenne_Load(object sender, EventArgs e)
        {

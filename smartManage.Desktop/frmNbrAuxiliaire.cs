...
{
    public partial class frmNbrAuxiliaire : Form
    {
        BindingSource bdsrc = new BindingSource();
        bool blnModifie = false;
        private clsauxiliaire materiel = new clsauxiliaire();
        int? newID = null;

        public frmNbrAuxiliaire()
        {
            InitializeComponent();
        }
        ...
        {
            bdsrc.DataSource = clsMetier.GetInstance().getAllClsauxiliaire();
        ...
        private void New()
        {
            ...
            //Set the new ID
            if (newID == null)
                newID = clsMetier.GetInstance().GenerateLastID("auxiliaire");
        ...
        private void Search(string criteria)
        {
            ...
            {
                List<clsauxiliaire> lstItemSearch = new List<clsauxiliaire>();
                lstItemSearch = clsMetier.GetInstance().getAllClsauxiliaire(criteria);
        ...
        {
            ((clsauxiliaire)bdsrc.Current).User_modified = smartManage.Desktop.Properties.Settings.Default.UserConnected;
            ((clsauxiliaire)bdsrc.Current).Date_modified = DateTime.Now;

            int record = materiel.update(((clsauxiliaire)bdsrc.Current));
        ...
        private void Delete()
        {
            if (blnModifie)
            {
                ...
                {
                    record = materiel.delete(((clsauxiliaire)bdsrc.Current));
        ...
        private void frmNbrAuxiliaire_Load(object sender, EventArgs e)
        {

...
{
    public partial class frmNbrCoeurProcesseur : Form
    {
        BindingSource bdsrc = new BindingSource();
        bool blnModifie = false;
        private clsnombre_coeur_processeur materiel = new clsnombre_coeur_processeur();
        int? newID = null;

        public frmNbrCoeurProcesseur()
        {
            InitializeComponent();
        }
        ...
        private void BindingCls()
        {
            ...
            SetBindingControls(txtValeur, "Text", materiel, "Valeur");
        ...
        private void BindingList()
        {
            ...
            SetBindingControls(txtValeur, "Text", bdsrc, "Valeur");
        ...
        {
            bdsrc.DataSource = clsMetier.GetInstance().getAllClsnombre_coeur_processeur();
        ...
        private void New()
        {
            ...
            materiel = new clsnombre_coeur_processeur();
            ...
            //Set the new ID
            if (newID == null)
                newID = clsMetier.GetInstance().GenerateLastID("nombre_coeur_processeur");
        ...
        private void Search(string criteria)
        {
            ...
            {
                List<clsnombre_coeur_processeur> lstItemSearch = new List<clsnombre_coeur_processeur>();
                lstItemSearch = clsMetier.GetInstance().getAllClsnombre_coeur_processeur(criteria);
        ...
        {
            ((clsnombre_coeur_processeur)bdsrc.Current).User_modified = smartManage.Desktop.Properties.Settings.Default.UserConnected;
            ((clsnombre_coeur_processeur)bdsrc.Current).Date_modified = DateTime.Now;

            int record = materiel.update(((clsnombre_coeur_processeur)bdsrc.Current));
        ...
        private void Delete()
        {
            if (blnModifie)
            {
                ...
                {
                    record = materiel.delete(((clsnombre_coeur_processeur)bdsrc.Current));
        ...
        private void frmNbrCoeurProcesseur_Load(object sender, EventArgs e)
        {

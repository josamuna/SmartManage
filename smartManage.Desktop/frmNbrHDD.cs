...
{
    public partial class frmNbrHDD : Form
    {
        BindingSource bdsrc = new BindingSource();
        bool blnModifie = false;
        private clsnombre_hdd materiel = new clsnombre_hdd();
        int? newID = null;
        ...
        {
            bdsrc.DataSource = clsMetier.GetInstance().getAllClsnombre_hdd();
        ...
        private void New()
        {
            ...
            //Set the new ID
            if (newID == null)
                newID = clsMetier.GetInstance().GenerateLastID("nombre_hdd");
        ...
        private void Search(string criteria)
        {
            ...
            {
                List<clsnombre_hdd> lstItemSearch = new List<clsnombre_hdd>();
                lstItemSearch = clsMetier.GetInstance().getAllClsnombre_hdd(criteria);
        ...
        {
            ((clsnombre_hdd)bdsrc.Current).User_modified = smartManage.Desktop.Properties.Settings.Default.UserConnected;
            ((clsnombre_hdd)bdsrc.Current).Date_modified = DateTime.Now;

            int record = materiel.update(((clsnombre_hdd)bdsrc.Current));
        ...
        private void Delete()
        {
            if (blnModifie)
            {
                ...
                {
                    record = materiel.delete(((clsnombre_hdd)bdsrc.Current));
        ...
        private void frmNbrHDD_Load(object sender, EventArgs e)
        {

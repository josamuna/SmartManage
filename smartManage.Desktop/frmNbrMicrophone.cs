...
{
    public partial class frmNbrMicrophone : Form
    {
        BindingSource bdsrc = new BindingSource();
        bool blnModifie = false;
        private clsmicrophone materiel = new clsmicrophone();
        int? newID = null;

        public frmNbrMicrophone()
        {
            InitializeComponent();
        }
        ...
        {
            bdsrc.DataSource = clsMetier.GetInstance().getAllClsmicrophone();
        ...
        private void New()
        {
            ...
            //Set the new ID
            if (newID == null)
                newID = clsMetier.GetInstance().GenerateLastID("microphone");
        ...
        private void Search(string criteria)
        {
            ...
            {
                List<clsmicrophone> lstItemSearch = new List<clsmicrophone>();
                lstItemSearch = clsMetier.GetInstance().getAllClsmicrophone(criteria);
        ...
        {
            ((clsmicrophone)bdsrc.Current).User_modified = smartManage.Desktop.Properties.Settings.Default.UserConnected;
            ((clsmicrophone)bdsrc.Current).Date_modified = DateTime.Now;

            int record = materiel.update(((clsmicrophone)bdsrc.Current));
        ...
        private void Delete()
        {
            if (blnModifie)
            {
                ...
                {
                    record = materiel.delete(((clsmicrophone)bdsrc.Current));
        ...
        private void frmNbrMicrophone_Load(object sender, EventArgs e)
        {

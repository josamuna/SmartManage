...
namespace smartManage.Desktop
{
    public partial class frmOS : Form
    {
        ...
        private void CallActualiseComboBoxModification()
        {
            ...
            {
                if (Properties.Settings.Default.strFormModifieSubForm.Equals(FormActualisation.frmTypeOS.ToString()))
                {
                    cboTypeOS.DataSource = clsMetier.GetInstance().getAllClstype_OS();
                    this.setMembersallcbo(cboTypeOS, "Designation", "Id");
                }
                else if (Properties.Settings.Default.strFormModifieSubForm.Equals(FormActualisation.frmArchitectureOS.ToString()))
                {
        ...
        {
            ((clsOS)bdsrc.Current).User_modified = Properties.Settings.Default.UserConnected;

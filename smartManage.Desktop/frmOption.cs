...
namespace smartManage.Desktop
{
    public partial class frmOption : Form
    {
        ...
        private clsoptio materiel = new clsoptio();
        int? newID = null;
        ...
        {
            bdsrc.DataSource = clsMetier.GetInstance().getAllClsoptio();
        ...
        private void New()
        {
            ...
            //Set the new ID
            if (newID == null)
                newID = clsMetier.GetInstance().GenerateLastID("optio");
        ...
        private void Search(string criteria)
        {
            ...
            {
                List<clsoptio> lstItemSearch = new List<clsoptio>();
                lstItemSearch = clsMetier.GetInstance().getAllClsoptio(criteria);
        ...
        {
            ((clsoptio)bdsrc.Current).User_modified = smartManage.Desktop.Properties.Settings.Default.UserConnected;
            ((clsoptio)bdsrc.Current).Date_modified = DateTime.Now;

            int record = materiel.update(((clsoptio)bdsrc.Current));
        ...
        private void Delete()
        {
            if (blnModifie)
            {
                ...
                {
                    record = materiel.delete(((clsoptio)bdsrc.Current));

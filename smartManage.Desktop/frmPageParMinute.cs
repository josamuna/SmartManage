...
{
    public partial class frmPageParMinute : Form
    {
        BindingSource bdsrc = new BindingSource();
        bool blnModifie = false;
        private clspage_par_minute materiel = new clspage_par_minute();
        int? newID = null;

        public frmPageParMinute()
        {
            InitializeComponent();
        }
        ...
        {
            bdsrc.DataSource = clsMetier.GetInstance().getAllClspage_par_minute();
        ...
        private void New()
        {
            ...
            materiel = new clspage_par_minute();
            ...
            //Set the new ID
            if (newID == null)
                newID = clsMetier.GetInstance().GenerateLastID("page_par_minute");
        ...
        private void Search(string criteria)
        {
            ...
            {
                List<clspage_par_minute> lstItemSearch = new List<clspage_par_minute>();
                lstItemSearch = clsMetier.GetInstance().getAllClspage_par_minute(criteria);
        ...
        {
            ((clspage_par_minute)bdsrc.Current).User_modified = smartManage.Desktop.Properties.Settings.Default.UserConnected;
            ((clspage_par_minute)bdsrc.Current).Date_modified = DateTime.Now;

            int record = materiel.update(((clspage_par_minute)bdsrc.Current));
        ...
        private void Delete()
        {
            if (blnModifie)
            {
                ...
                {
                    record = materiel.delete(((clspage_par_minute)bdsrc.Current));
        ...
        private void frmPageParMinute_Load(object sender, EventArgs e)
        {

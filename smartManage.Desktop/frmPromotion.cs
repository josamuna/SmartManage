...
namespace smartManage.Desktop
{
    public partial class frmPromotion : Form
    {
        ...
        private clspromotion materiel = new clspromotion();
        int? newID = null;
        ...
        {
            bdsrc.DataSource = clsMetier.GetInstance().getAllClspromotion();
        ...
        private void New()
        {
            ...
            //Set the new ID
            if (newID == null)
                newID = clsMetier.GetInstance().GenerateLastID("promotion");
        ...
        private void Search(string criteria)
        {
            ...
            {
                List<clspromotion> lstItemSearch = new List<clspromotion>();
                lstItemSearch = clsMetier.GetInstance().getAllClspromotion(criteria);
        ...
        {
            ((clspromotion)bdsrc.Current).User_modified = smartManage.Desktop.Properties.Settings.Default.UserConnected;
            ((clspromotion)bdsrc.Current).Date_modified = DateTime.Now;

            int record = materiel.update(((clspromotion)bdsrc.Current));
        ...
        private void Delete()
        {
            if (blnModifie)
            {
                ...
                {
                    record = materiel.delete(((clspromotion)bdsrc.Current));

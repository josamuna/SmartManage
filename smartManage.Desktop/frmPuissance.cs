...
{
    public partial class frmPuissance : Form
    {
        BindingSource bdsrc = new BindingSource();
        bool blnModifie = false;
        private clspuissance materiel = new clspuissance();
        int? newID = null;
        ...
        {
            bdsrc.DataSource = clsMetier.GetInstance().getAllClspuissance();
        ...
        private void New()
        {
            ...
            //Set the new ID
            if (newID == null)
                newID = clsMetier.GetInstance().GenerateLastID("puissance");
        ...
        private void Search(string criteria)
        {
            ...
            {
                List<clspuissance> lstItemSearch = new List<clspuissance>();
                lstItemSearch = clsMetier.GetInstance().getAllClspuissance(criteria);
        ...
        {
            ((clspuissance)bdsrc.Current).User_modified = smartManage.Desktop.Properties.Settings.Default.UserConnected;
            ((clspuissance)bdsrc.Current).Date_modified = DateTime.Now;

            int record = materiel.update(((clspuissance)bdsrc.Current));
        ...
        private void Delete()
        {
            if (blnModifie)
            {
                ...
                {
                    record = materiel.delete(((clspuissance)bdsrc.Current));
        ...
        private void frmPuissance_Load(object sender, EventArgs e)
        {

...
{
    public partial class frmPuissanceAdaptateur : Form
    {
        BindingSource bdsrc = new BindingSource();
        bool blnModifie = false;
        private clspuissance_adaptateur materiel = new clspuissance_adaptateur();
        int? newID = null;

        public frmPuissanceAdaptateur()
        {
            InitializeComponent();
        }
        ...
        {
            bdsrc.DataSource = clsMetier.GetInstance().getAllClspuissance_adaptateur();
        ...
        private void New()
        {
            ...
            materiel = new clspuissance_adaptateur();
            ...
            //Set the new ID
            if (newID == null)
                newID = clsMetier.GetInstance().GenerateLastID("puissance_adaptateur");
        ...
        private void Search(string criteria)
        {
            ...
            {
                List<clspuissance_adaptateur> lstItemSearch = new List<clspuissance_adaptateur>();
                lstItemSearch = clsMetier.GetInstance().getAllClspuissance_adaptateur(criteria);
        ...
        {
            ((clspuissance_adaptateur)bdsrc.Current).User_modified = smartManage.Desktop.Properties.Settings.Default.UserConnected;
            ((clspuissance_adaptateur)bdsrc.Current).Date_modified = DateTime.Now;

            int record = materiel.update(((clspuissance_adaptateur)bdsrc.Current));
        ...
        private void Delete()
        {
            if (blnModifie)
            {
                ...
                {
                    record = materiel.delete(((clspuissance_adaptateur)bdsrc.Current));
        ...
        private void frmPuissanceAdaptateur_Load(object sender, EventArgs e)
        {

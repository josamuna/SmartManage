...
{
    public partial class frmRetroprojecteur : Form, ICRUDGeneral, ICallMainForm
    {
        ...
        private void LoadMiddleCombo(string threadName)
        {
            try
            {
                ...
                this.setMembersallcbo(cboNetete, "Designation", "Id");
                ...
                List<ComboBox> lstCombo = new List<ComboBox>() { cboNetete, cboTensionAlimentation, cboPuissance, cboIntensite };
        ...
        private void LoadDataGrid(string threadName)
        {
            try
            {
                ...
                bdsrc.DataSource = clsMetier.GetInstance().getAllClsmateriel_Retroprojecteur();
        ...
        private void GenerateQrCode(string threadName)
        {
            try
            {
                ...
                txtLabel.Text = clsMetier.GetInstance().GenerateLabelMateriel(Convert.ToInt32(txtId.Text), "ILRetro");
        ...
        private void CallActualiseComboBoxModification(string threadName)
        {
            ...
            try
            {
                if (!string.IsNullOrEmpty(Properties.Settings.Default.strFormModifieSubForm))
                {
                    ...
                    else if (Properties.Settings.Default.strFormModifieSubForm.Equals(FormActualisation.frmNetete.ToString()))
                    {
                        cboNetete.DataSource = clsMetier.GetInstance().getAllClsnetette();
                        this.setMembersallcbo(cboNetete, "Designation", "Id");
                    }
        ...
        private void BindingCls()
        {
            ...
            SetBindingControls(cboNetete, "SelectedValue", materiel, "Id_netette");
            ...
            SetBindingControls(chkCompatibleWifi, "Checked", materiel, "Compatible_wifi");                   
        }
        ...
        private void BindingList()
        {
            ...
            SetBindingControls(cboNetete, "SelectedValue", bdsrc, "Id_netette");
            ...
            SetBindingControls(chkCompatibleWifi, "Checked", bdsrc, "Compatible_wifi");
        }
        #endregion
        ...
        public void New()
        {
            try
            {
                ...
                cboCatMateriel.Text = clsMetier.GetInstance().getClscategorie_materiel("6").Designation.ToString();
            }
            catch (ArgumentException ex)
            {
        ...
        private void cboNetete_DropDown(object sender, EventArgs e)
        {
            DoActualiseDropDown();
        }

        private void lblAddNetete_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            frmNetete frm = new frmNetete();
            frm.Icon = this.Icon;
            frm.ShowDialog();
        }

        private void frmRetroprojecteur_FormClosed(object sender, FormClosedEventArgs e)
        {
        ...
        {
            Principal.SetValuesLabel(Properties.Settings.Default.UserConnected, "Gestion des rétroprojecteurs");
        ...
        private void frmRetroprojecteur_Load(object sender, EventArgs e)
        {
            cmdArchiver.Enabled = false;

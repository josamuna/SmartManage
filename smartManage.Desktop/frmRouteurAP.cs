...
{
    public partial class frmRouteurAP : Form, ICRUDGeneral, ICallMainForm
    {
        ...
        private void LoadMiddleCombo(string threadName)
        {
            try
            {
                ...
                cboTypeRouteurAP.DataSource = clsMetier.GetInstance().getAllClstype_routeur_AP();
                this.setMembersallcbo(cboTypeRouteurAP, "Designation", "Id");
                cboVersionIOS.DataSource = clsMetier.GetInstance().getAllClsversion_ios();
                this.setMembersallcbo(cboVersionIOS, "Designation", "Id");
                cboNbrGbe.DataSource = clsMetier.GetInstance().getAllClsgbe();
                this.setMembersallcbo(cboNbrGbe, "Valeur", "Id");
                cboNbrFe.DataSource = clsMetier.GetInstance().getAllClsfe();
                this.setMembersallcbo(cboNbrFe, "Valeur", "Id");
                cboNbrFo.DataSource = clsMetier.GetInstance().getAllClsfo();
                this.setMembersallcbo(cboNbrFo, "Valeur", "Id");
                cboNbrSerial.DataSource = clsMetier.GetInstance().getAllClsserial();
                this.setMembersallcbo(cboNbrSerial, "Valeur", "Id");
                cboDefaultPassword.DataSource = clsMetier.GetInstance().getAllClsdefault_pwd();
                this.setMembersallcbo(cboDefaultPassword, "Designation", "Id");
                cboDefaultIP.DataSource = clsMetier.GetInstance().getAllClsdefault_ip();
                this.setMembersallcbo(cboDefaultIP, "Designation", "Id");
                cboNbrConsole.DataSource = clsMetier.GetInstance().getAllClsconsole();
                this.setMembersallcbo(cboNbrConsole, "Valeur", "Id");
                cboNbrAuxiliaire.DataSource = clsMetier.GetInstance().getAllClsauxiliaire();
                this.setMembersallcbo(cboNbrAuxiliaire, "Valeur", "Id");
                ...
                List<ComboBox> lstCombo = new List<ComboBox>() { cboTypeRouteurAP, cboVersionIOS, cboNbrGbe, cboNbrFe, cboNbrFo, cboNbrSerial,
                    cboDefaultPassword, cboDefaultIP, cboNbrConsole, cboNbrAuxiliaire, cboTensionAlimentation, cboPuissance, cboIntensite };
        ...
        private void LoadDataGrid(string threadName)
        {
            try
            {
                ...
                bdsrc.DataSource = clsMetier.GetInstance().getAllClsmateriel_Routeur_AP();
        ...
        private void GenerateQrCode(string threadName)
        {
            try
            {
                ...
                txtLabel.Text = clsMetier.GetInstance().GenerateLabelMateriel(Convert.ToInt32(txtId.Text), "ILR_AP");
        ...
        private void CallActualiseComboBoxModification(string threadName)
        {
            ...
            try
            {
                if (!string.IsNullOrEmpty(Properties.Settings.Default.strFormModifieSubForm))
                {
                    ...
                    else if (Properties.Settings.Default.strFormModifieSubForm.Equals(FormActualisation.frmTypeRouteurAP.ToString()))
                    {
                        cboTypeRouteurAP.DataSource = clsMetier.GetInstance().getAllClstype_routeur_AP();
                        this.setMembersallcbo(cboTypeRouteurAP, "Designation", "Id");
                    }
                    else if (Properties.Settings.Default.strFormModifieSubForm.Equals(FormActualisation.frmVersionIOS.ToString()))
                    {
                        cboVersionIOS.DataSource = clsMetier.GetInstance().getAllClsversion_ios();
                        this.setMembersallcbo(cboVersionIOS, "Designation", "Id");
                    }
                    else if (Properties.Settings.Default.strFormModifieSubForm.Equals(FormActualisation.frmNbrGBE.ToString()))
                    {
                        cboNbrGbe.DataSource = clsMetier.GetInstance().getAllClsgbe();
                        this.setMembersallcbo(cboNbrGbe, "Valeur", "Id");
                    }
                    ...
                    else if (Properties.Settings.Default.strFormModifieSubForm.Equals(FormActualisation.frmNbrFE.ToString()))
                    {
                        cboNbrFe.DataSource = clsMetier.GetInstance().getAllClsfe();
                        this.setMembersallcbo(cboNbrFe, "Valeur", "Id");
                    }
                    else if (Properties.Settings.Default.strFormModifieSubForm.Equals(FormActualisation.frmNbrFO.ToString()))
                    {
                        cboNbrFo.DataSource = clsMetier.GetInstance().getAllClsfo();
                        this.setMembersallcbo(cboNbrFo, "Valeur", "Id");
                    }
                    else if (Properties.Settings.Default.strFormModifieSubForm.Equals(FormActualisation.frmNbrSerial.ToString()))
                    {
                        cboNbrSerial.DataSource = clsMetier.GetInstance().getAllClsserial();
                        this.setMembersallcbo(cboNbrSerial, "Valeur", "Id");
                    }
                    else if (Properties.Settings.Default.strFormModifieSubForm.Equals(FormActualisation.frmDefaultPwd.ToString()))
                    {
                        cboDefaultPassword.DataSource = clsMetier.GetInstance().getAllClsdefault_pwd();
                        this.setMembersallcbo(cboDefaultPassword, "Designation", "Id");
                    }
                    else if (Properties.Settings.Default.strFormModifieSubForm.Equals(FormActualisation.frmDefaultIP.ToString()))
                    {
                        cboDefaultIP.DataSource = clsMetier.GetInstance().getAllClsdefault_ip();
                        this.setMembersallcbo(cboDefaultIP, "Designation", "Id");
                    }
                    else if (Properties.Settings.Default.strFormModifieSubForm.Equals(FormActualisation.frmNbrConsole.ToString()))
                    {
                        cboNbrConsole.DataSource = clsMetier.GetInstance().getAllClsconsole();
                        this.setMembersallcbo(cboNbrConsole, "Valeur", "Id");
                    }
                    else if (Properties.Settings.Default.strFormModifieSubForm.Equals(FormActualisation.frmNbrAuxiliaire.ToString()))
                    {
                        cboNbrAuxiliaire.DataSource = clsMetier.GetInstance().getAllClsauxiliaire();
                        this.setMembersallcbo(cboNbrAuxiliaire, "Valeur", "Id");
                    }
                    ...
                    else if (Properties.Settings.Default.strFormModifieSubForm.Equals(FormActualisation.frmPuissance.ToString()))
                    {
                        cboPuissance.DataSource = clsMetier.GetInstance().getAllClspuissance();
                        this.setMembersallcbo(cboPuissance, "Valeur", "Id");
                    }
                    else if (Properties.Settings.Default.strFormModifieSubForm.Equals(FormActualisation.frmIntensite.ToString()))
                    {
                        cboIntensite.DataSource = clsMetier.GetInstance().getAllClsintensite();
                        this.setMembersallcbo(cboIntensite, "Valeur", "Id");
                    }
        ...
        private void BindingCls()
        {
            ...
            //Partie pour routeurAP
            SetBindingControls(cboTypeRouteurAP, "SelectedValue", materiel, "Id_type_routeur_ap");
            SetBindingControls(cboVersionIOS, "SelectedValue", materiel, "Id_version_ios");
            SetBindingControls(cboNbrGbe, "SelectedValue", materiel, "Id_gbe");
            SetBindingControls(cboNbrFe, "SelectedValue", materiel, "Id_fe");
            SetBindingControls(cboNbrFo, "SelectedValue", materiel, "Id_fo");
            SetBindingControls(cboNbrSerial, "SelectedValue", materiel, "Id_serial");
            SetBindingControls(chkUSBCapable, "Checked", materiel, "Capable_usb");
            SetBindingControls(cboDefaultPassword, "SelectedValue", materiel, "Id_default_pwd");
            SetBindingControls(cboDefaultIP, "SelectedValue", materiel, "Id_default_ip");
            SetBindingControls(cboNbrConsole, "SelectedValue", materiel, "Id_console");
            SetBindingControls(cboNbrAuxiliaire, "SelectedValue", materiel, "Id_auxiliaire");
        ...
        private void BindingList()
        {
            ...
            //Partie pour routeurAP
            SetBindingControls(cboTypeRouteurAP, "SelectedValue", bdsrc, "Id_type_routeur_ap");
            SetBindingControls(cboVersionIOS, "SelectedValue", bdsrc, "Id_version_ios");
            SetBindingControls(cboNbrGbe, "SelectedValue", bdsrc, "Id_gbe");
            SetBindingControls(cboNbrFe, "SelectedValue", bdsrc, "Id_fe");
            SetBindingControls(cboNbrFo, "SelectedValue", bdsrc, "Id_fo");
            SetBindingControls(cboNbrSerial, "SelectedValue", bdsrc, "Id_serial");
            SetBindingControls(chkUSBCapable, "Checked", bdsrc, "Capable_usb"); 
            SetBindingControls(cboDefaultPassword, "SelectedValue", bdsrc, "Id_default_pwd");
            SetBindingControls(cboDefaultIP, "SelectedValue", bdsrc, "Id_default_ip");
            SetBindingControls(cboNbrConsole, "SelectedValue", bdsrc, "Id_console");
            SetBindingControls(cboNbrAuxiliaire, "SelectedValue", bdsrc, "Id_auxiliaire");
        ...
        public void New()
        {
            try
            {
                ...
                cboCatMateriel.Text = clsMetier.GetInstance().getClscategorie_materiel("7").Designation.ToString();
            }
            catch (ArgumentException ex)
            {
        ...
        public void Preview()
        {
            frmReportRouteurAP frm = new frmReportRouteurAP();
        ...
        private void cboTypeRouteurAP_DropDown(object sender, EventArgs e)
        {
            DoActualiseDropDown();
        }

        private void cboVersionIOS_DropDown(object sender, EventArgs e)
        {
            DoActualiseDropDown();
        }

        private void cboNbrGbe_DropDown(object sender, EventArgs e)
        {
            DoActualiseDropDown();
        }

        private void cboNbrFe_DropDown(object sender, EventArgs e)
        {
            DoActualiseDropDown();
        }

        private void cboNbrFo_DropDown(object sender, EventArgs e)
        {
            DoActualiseDropDown();
        }

        private void cboNbrSerial_DropDown(object sender, EventArgs e)
        {
            DoActualiseDropDown();
        }

        private void cboDefaultPassword_DropDown(object sender, EventArgs e)
        {
            DoActualiseDropDown();
        }

        private void cboDefaultIP_DropDown(object sender, EventArgs e)
        {
            DoActualiseDropDown();
        }

        private void cboNbrConsole_DropDown(object sender, EventArgs e)
        {
            DoActualiseDropDown();
        }

        private void cboNbrAuxiliaire_DropDown(object sender, EventArgs e)
        {
            DoActualiseDropDown();
        }

        private void lblAddTypeRouteurAP_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            frmTypeRouteurAP frm = new frmTypeRouteurAP();
            frm.Icon = this.Icon;
            frm.ShowDialog();
        }

        private void lblAddAuxiliaire_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            frmNbrAuxiliaire frm = new frmNbrAuxiliaire();
            frm.Icon = this.Icon;
            frm.ShowDialog();
        }

        private void lblAddConsole_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            frmNbrConsole frm = new frmNbrConsole();
            frm.Icon = this.Icon;
            frm.ShowDialog();
        }

        private void lblAddDefaultIP_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            frmDefaultIP frm = new frmDefaultIP();
            frm.Icon = this.Icon;
            frm.ShowDialog();
        }

        private void lblAddDefaultPwd_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            frmDefaultPwd frm = new frmDefaultPwd();
            frm.Icon = this.Icon;
            frm.ShowDialog();
        }

        private void lblAddSerial_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            frmNbrSerial frm = new frmNbrSerial();
            frm.Icon = this.Icon;
            frm.ShowDialog();
        }

        private void lblAddFo_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            frmNbrFO frm = new frmNbrFO();
            frm.Icon = this.Icon;
            frm.ShowDialog();
        }

        private void lblAddFe_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            frmNbrFE frm = new frmNbrFE();
            frm.Icon = this.Icon;
            frm.ShowDialog();
        }

        private void lblAddGbe_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            frmNbrGBE frm = new frmNbrGBE();
            frm.Icon = this.Icon;
            frm.ShowDialog();
        }

        private void lblAddVersionIOS_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            frmVersionIOS frm = new frmVersionIOS();
            frm.Icon = this.Icon;
            frm.ShowDialog();
        }
        ...
        private void frmRouteurAP_Load(object sender, EventArgs e)
        {
            cmdArchiver.Enabled = false;
        ...
        private void frmRouteurAP_FormClosed(object sender, FormClosedEventArgs e)
        {
        ...
        private void frmRouteurAP_Activated(object sender, EventArgs e)
        {
            Principal.SetValuesLabel(Properties.Settings.Default.UserConnected, "Gestion des routeur-access point");

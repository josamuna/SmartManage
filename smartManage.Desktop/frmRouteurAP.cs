        ...
        private void CallActualiseComboBoxModification(string threadName)
        {
            ...
            try
            {
                if (!string.IsNullOrEmpty(smartManage.Desktop.Properties.Settings.Default.strFormModifieSubForm))
                {
                    ...
                    else if (smartManage.Desktop.Properties.Settings.Default.strFormModifieSubForm.Equals(FormActualisation.frmTypeRouteurAP.ToString()))
                    {
                        cboTypeRouteurAP.DataSource = clsMetier.GetInstance().getAllClstype_routeur_AP();
                        this.setMembersallcbo(cboTypeRouteurAP, "Designation", "Id");
                    }
                    else if (smartManage.Desktop.Properties.Settings.Default.strFormModifieSubForm.Equals(FormActualisation.frmVersionIOS.ToString()))
                    {
                        cboVersionIOS.DataSource = clsMetier.GetInstance().getAllClsversion_ios();
                        this.setMembersallcbo(cboVersionIOS, "Designation", "Id");
                    }
                    else if (smartManage.Desktop.Properties.Settings.Default.strFormModifieSubForm.Equals(FormActualisation.frmNbrGBE.ToString()))
                    {
                        cboNbrGbe.DataSource = clsMetier.GetInstance().getAllClsgbe();
                        this.setMembersallcbo(cboNbrGbe, "Valeur", "Id");
                    }
                    ...
                    else if (smartManage.Desktop.Properties.Settings.Default.strFormModifieSubForm.Equals(FormActualisation.frmNbrFE.ToString()))
                    {
                        cboNbrFe.DataSource = clsMetier.GetInstance().getAllClsfe();
                        this.setMembersallcbo(cboNbrFe, "Valeur", "Id");
                    }
                    else if (smartManage.Desktop.Properties.Settings.Default.strFormModifieSubForm.Equals(FormActualisation.frmNbrFO.ToString()))
                    {
                        cboNbrFo.DataSource = clsMetier.GetInstance().getAllClsfo();
                        this.setMembersallcbo(cboNbrFo, "Valeur", "Id");
                    }
                    else if (smartManage.Desktop.Properties.Settings.Default.strFormModifieSubForm.Equals(FormActualisation.frmNbrSerial.ToString()))
                    {
                        cboNbrSerial.DataSource = clsMetier.GetInstance().getAllClsserial();
                        this.setMembersallcbo(cboNbrSerial, "Valeur", "Id");
                    }
                    else if (smartManage.Desktop.Properties.Settings.Default.strFormModifieSubForm.Equals(FormActualisation.frmDefaultPwd.ToString()))
                    {
                        cboDefaultPassword.DataSource = clsMetier.GetInstance().getAllClsdefault_pwd();
                        this.setMembersallcbo(cboDefaultPassword, "Designation", "Id");
                    }
                    else if (smartManage.Desktop.Properties.Settings.Default.strFormModifieSubForm.Equals(FormActualisation.frmDefaultIP.ToString()))
                    {
                        cboDefaultIP.DataSource = clsMetier.GetInstance().getAllClsdefault_ip();
                        this.setMembersallcbo(cboDefaultIP, "Designation", "Id");
                    }
                    else if (smartManage.Desktop.Properties.Settings.Default.strFormModifieSubForm.Equals(FormActualisation.frmNbrConsole.ToString()))
                    {
                        cboNbrConsole.DataSource = clsMetier.GetInstance().getAllClsconsole();
                        this.setMembersallcbo(cboNbrConsole, "Valeur", "Id");
                    }
                    else if (smartManage.Desktop.Properties.Settings.Default.strFormModifieSubForm.Equals(FormActualisation.frmNbrAuxiliaire.ToString()))
                    {
                        cboNbrAuxiliaire.DataSource = clsMetier.GetInstance().getAllClsauxiliaire();
                        this.setMembersallcbo(cboNbrAuxiliaire, "Valeur", "Id");
                    }

...
namespace smartManage.Desktop
{
    public partial class frmSalle : Form
    {
        ...
        private clssalle materiel = new clssalle();
        int? newID = null;
        ...
        {
            bdsrc.DataSource = clsMetier.GetInstance().getAllClssalle();
        ...
        private void New()
        {
            ...
            //Set the new ID
            if (newID == null)
                newID = clsMetier.GetInstance().GenerateLastID("salle");
        ...
        private void Search(string criteria)
        {
            ...
            {
                List<clssalle> lstItemSearch = new List<clssalle>();
                lstItemSearch = clsMetier.GetInstance().getAllClssalle(criteria);
        ...
        {
            ((clssalle)bdsrc.Current).User_modified = smartManage.Desktop.Properties.Settings.Default.UserConnected;
            ((clssalle)bdsrc.Current).Date_modified = DateTime.Now;

            int record = materiel.update(((clssalle)bdsrc.Current));
        ...
        private void Delete()
        {
            if (blnModifie)
            {
                ...
                {
                    record = materiel.delete(((clssalle)bdsrc.Current));

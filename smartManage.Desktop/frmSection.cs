...
namespace smartManage.Desktop
{
    public partial class frmSection : Form
    {
        ...
        private clssection materiel = new clssection();
        int? newID = null;
        ...
        private void BindingCls()
        {
            ...
            SetBindingControls(txtDesignation1, "Text", materiel, "Designation1");
            SetBindingControls(txtDesignation2, "Text", materiel, "Designation2");
        ...
        private void BindingList()
        {
            ...
            SetBindingControls(txtDesignation1, "Text", bdsrc, "Designation1");
            SetBindingControls(txtDesignation2, "Text", bdsrc, "Designation2");
        ...
        {
            bdsrc.DataSource = clsMetier.GetInstance().getAllClssection();
        ...
        private void New()
        {
            ...
            //Set the new ID
            if (newID == null)
                newID = clsMetier.GetInstance().GenerateLastID("section");
        ...
        private void Search(string criteria)
        {
            ...
            {
                List<clssection> lstItemSearch = new List<clssection>();
                lstItemSearch = clsMetier.GetInstance().getAllClssection(criteria);
        ...
        {
            ((clssection)bdsrc.Current).User_modified = smartManage.Desktop.Properties.Settings.Default.UserConnected;
            ((clssection)bdsrc.Current).Date_modified = DateTime.Now;

            int record = materiel.update(((clssection)bdsrc.Current));
        ...
        private void Delete()
        {
            if (blnModifie)
            {
                ...
                {
                    record = materiel.delete(((clssection)bdsrc.Current));

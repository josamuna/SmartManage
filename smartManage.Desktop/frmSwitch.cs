...
{
    public partial class frmSwitch : Form, ICRUDGeneral, ICallMainForm
    {
        ...
        private void LoadMiddleCombo(string threadName)
        {
            try
            {
                ...
                cboTypeSwitch.DataSource = clsMetier.GetInstance().getAllClstype_routeur_AP();
                this.setMembersallcbo(cboTypeSwitch, "Designation", "Id");
                ...
                List<ComboBox> lstCombo = new List<ComboBox>() { cboTypeSwitch, cboVersionIOS, cboNbrGbe, cboNbrFe, cboNbrFo, 
        ...
        private void LoadDataGrid(string threadName)
        {
            try
            {
                ...
                bdsrc.DataSource = clsMetier.GetInstance().getAllClsmateriel_Switch();
        ...
        private void GenerateQrCode(string threadName)
        {
            try
            {
                ...
                txtLabel.Text = clsMetier.GetInstance().GenerateLabelMateriel(Convert.ToInt32(txtId.Text), "ILSw");
        ...
        private void BindingCls()
        {
            ...
            //Partie pour Switch
            SetBindingControls(cboTypeSwitch, "SelectedValue", materiel, "Id_type_switch");
        ...
        private void BindingList()
        {
            ...
            //Partie pour Switch
            SetBindingControls(cboTypeSwitch, "SelectedValue", bdsrc, "Id_type_switch");
        ...
        public void New()
        {
            try
            {
                ...
                cboCatMateriel.Text = clsMetier.GetInstance().getClscategorie_materiel("2").Designation.ToString();
            }
            catch (ArgumentException ex)
            {
        ...
        private void cboTypeSwitch_DropDown(object sender, EventArgs e)
        {
            DoActualiseDropDown();
        }
        ...
        private void frmSwitch_Activated(object sender, EventArgs e)
        {
            Principal.SetValuesLabel(Properties.Settings.Default.UserConnected, "Gestion des switch ou commutateur");

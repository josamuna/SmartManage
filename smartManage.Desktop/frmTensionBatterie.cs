...
{
    public partial class frmTensionBatterie : Form
    {
        BindingSource bdsrc = new BindingSource();
        bool blnModifie = false;
        private clstension_batterie materiel = new clstension_batterie();
        int? newID = null;

        public frmTensionBatterie()
        {
            InitializeComponent();
        }
        ...
        {
            bdsrc.DataSource = clsMetier.GetInstance().getAllClstension_batterie();
        ...
        private void New()
        {
            ...
            materiel = new clstension_batterie();
            ...
            //Set the new ID
            if (newID == null)
                newID = clsMetier.GetInstance().GenerateLastID("tension_batterie");
        ...
        private void Search(string criteria)
        {
            ...
            {
                List<clstension_batterie> lstItemSearch = new List<clstension_batterie>();
                lstItemSearch = clsMetier.GetInstance().getAllClstension_batterie(criteria);
        ...
        {
            ((clstension_batterie)bdsrc.Current).User_modified = smartManage.Desktop.Properties.Settings.Default.UserConnected;
            ((clstension_batterie)bdsrc.Current).Date_modified = DateTime.Now;

            int record = materiel.update(((clstension_batterie)bdsrc.Current));
        ...
        private void Delete()
        {
            if (blnModifie)
            {
                ...
                {
                    record = materiel.delete(((clstension_batterie)bdsrc.Current));
        ...
        private void frmTensionBatterie_Load(object sender, EventArgs e)
        {

...
{
    public partial class frmTypeClavier : Form
    {
        BindingSource bdsrc = new BindingSource();
        bool blnModifie = false;
        private clstype_clavier materiel = new clstype_clavier();
        int? newID = null;

        public frmTypeClavier()
        {
            InitializeComponent();
        }
        ...
        {
            bdsrc.DataSource = clsMetier.GetInstance().getAllClstype_clavier();
        ...
        private void New()
        {
            ...
            //Set the new ID
            if (newID == null)
                newID = clsMetier.GetInstance().GenerateLastID("type_clavier");
        ...
        private void Search(string criteria)
        {
            ...
            {
                List<clstype_clavier> lstItemSearch = new List<clstype_clavier>();
                lstItemSearch = clsMetier.GetInstance().getAllClstype_clavier(criteria);
        ...
        {
            ((clstype_clavier)bdsrc.Current).User_modified = smartManage.Desktop.Properties.Settings.Default.UserConnected;
            ((clstype_clavier)bdsrc.Current).Date_modified = DateTime.Now;

            int record = materiel.update(((clstype_clavier)bdsrc.Current));
        ...
        private void Delete()
        {
            if (blnModifie)
            {
                ...
                {
                    record = materiel.delete(((clstype_clavier)bdsrc.Current));
        ...
        private void frmTypeClavier_Load(object sender, EventArgs e)
        {

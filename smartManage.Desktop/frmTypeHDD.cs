...
{
    public partial class frmTypeHDD : Form
    {
        BindingSource bdsrc = new BindingSource();
        bool blnModifie = false;
        private clstype_hdd materiel = new clstype_hdd();
        int? newID = null;
        ...
        {
            bdsrc.DataSource = clsMetier.GetInstance().getAllClstype_hdd();
        ...
        private void New()
        {
            ...
            //Set the new ID
            if (newID == null)
                newID = clsMetier.GetInstance().GenerateLastID("type_hdd");
        ...
        private void Search(string criteria)
        {
            ...
            {
                List<clstype_hdd> lstItemSearch = new List<clstype_hdd>();
                lstItemSearch = clsMetier.GetInstance().getAllClstype_hdd(criteria);
        ...
        {
            ((clstype_hdd)bdsrc.Current).User_modified = smartManage.Desktop.Properties.Settings.Default.UserConnected;
            ((clstype_hdd)bdsrc.Current).Date_modified = DateTime.Now;

            int record = materiel.update(((clstype_hdd)bdsrc.Current));
        ...
        private void Delete()
        {
            if (blnModifie)
            {
                ...
                {
                    record = materiel.delete(((clstype_hdd)bdsrc.Current));
        ...
        private void frmTypeHDD_Load(object sender, EventArgs e)
        {

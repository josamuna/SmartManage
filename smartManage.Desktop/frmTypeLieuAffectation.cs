...
{
    public partial class frmTypeLieuAffectation : Form
    {
        BindingSource bdsrc = new BindingSource();
        bool blnModifie = false;
        private clstype_lieu_affectation materiel = new clstype_lieu_affectation();
        int? newID = null;

        public frmTypeLieuAffectation()
        {
            InitializeComponent();
        }
        ...
        {
            bdsrc.DataSource = clsMetier.GetInstance().getAllClstype_lieu_affectation();
        ...
        private void New()
        {
            ...
            materiel = new clstype_lieu_affectation();
            ...
            //Set the new ID
            if (newID == null)
                newID = clsMetier.GetInstance().GenerateLastID("type_lieu_affectation");
        ...
        private void Search(string criteria)
        {
            ...
            {
                List<clstype_lieu_affectation> lstItemSearch = new List<clstype_lieu_affectation>();
                lstItemSearch = clsMetier.GetInstance().getAllClstype_lieu_affectation(criteria);
        ...
        {
            ((clstype_lieu_affectation)bdsrc.Current).User_modified = smartManage.Desktop.Properties.Settings.Default.UserConnected;
            ((clstype_lieu_affectation)bdsrc.Current).Date_modified = DateTime.Now;

            int record = materiel.update(((clstype_lieu_affectation)bdsrc.Current));
        ...
        private void Delete()
        {
            if (blnModifie)
            {
                ...
                {
                    record = materiel.delete(((clstype_lieu_affectation)bdsrc.Current));
        ...
        private void frmTypeLieuAffectation_Load(object sender, EventArgs e)
        {

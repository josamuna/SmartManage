...
{
    public partial class frmTypeOrdinateur : Form
    {
        BindingSource bdsrc = new BindingSource();
        bool blnModifie = false;
        private clstype_ordinateur materiel = new clstype_ordinateur();
        int? newID = null;

        public frmTypeOrdinateur()
        {
            InitializeComponent();
        }
        ...
        {
            bdsrc.DataSource = clsMetier.GetInstance().getAllClstype_ordinateur();
        ...
        private void New()
        {
            ...
            materiel = new clstype_ordinateur();
            ...
            //Set the new ID
            if (newID == null)
                newID = clsMetier.GetInstance().GenerateLastID("type_ordinateur");
        ...
        private void Search(string criteria)
        {
            ...
            {
                List<clstype_ordinateur> lstItemSearch = new List<clstype_ordinateur>();
                lstItemSearch = clsMetier.GetInstance().getAllClstype_ordinateur(criteria);
        ...
        {
            ((clstype_ordinateur)bdsrc.Current).User_modified = smartManage.Desktop.Properties.Settings.Default.UserConnected;
            ((clstype_ordinateur)bdsrc.Current).Date_modified = DateTime.Now;

            int record = materiel.update(((clstype_ordinateur)bdsrc.Current));
        ...
        private void Delete()
        {
            if (blnModifie)
            {
                ...
                {
                    record = materiel.delete(((clstype_ordinateur)bdsrc.Current));
        ...
        private void frmTypeOrdinateur_Load(object sender, EventArgs e)
        {

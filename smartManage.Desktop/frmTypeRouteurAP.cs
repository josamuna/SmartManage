...
{
    public partial class frmTypeRouteurAP : Form
    {
        BindingSource bdsrc = new BindingSource();
        bool blnModifie = false;
        private clstype_routeur_AP materiel = new clstype_routeur_AP();
        int? newID = null;

        public frmTypeRouteurAP()
        {
            InitializeComponent();
        }
        ...
        {
            bdsrc.DataSource = clsMetier.GetInstance().getAllClstype_routeur_AP();
        ...
        private void New()
        {
            ...
            materiel = new clstype_routeur_AP();
            ...
            //Set the new ID
            if (newID == null)
                newID = clsMetier.GetInstance().GenerateLastID("type_routeur_AP");
        ...
        private void Search(string criteria)
        {
            ...
            {
                List<clstype_routeur_AP> lstItemSearch = new List<clstype_routeur_AP>();
                lstItemSearch = clsMetier.GetInstance().getAllClstype_routeur_AP(criteria);
        ...
        {
            ((clstype_routeur_AP)bdsrc.Current).User_modified = smartManage.Desktop.Properties.Settings.Default.UserConnected;
            ((clstype_routeur_AP)bdsrc.Current).Date_modified = DateTime.Now;

            int record = materiel.update(((clstype_routeur_AP)bdsrc.Current));
        ...
        private void Delete()
        {
            if (blnModifie)
            {
                ...
                {
                    record = materiel.delete(((clstype_routeur_AP)bdsrc.Current));
        ...
        private void frmTypeRouteurAP_Load(object sender, EventArgs e)
        {

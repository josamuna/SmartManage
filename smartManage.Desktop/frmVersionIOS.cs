...
{
    public partial class frmVersionIOS : Form
    {
        BindingSource bdsrc = new BindingSource();
        bool blnModifie = false;
        private clsversion_ios materiel = new clsversion_ios();
        int? newID = null;

        public frmVersionIOS()
        {
            InitializeComponent();
        }
        ...
        {
            bdsrc.DataSource = clsMetier.GetInstance().getAllClsversion_ios();
        ...
        private void New()
        {
            ...
            //Set the new ID
            if (newID == null)
                newID = clsMetier.GetInstance().GenerateLastID("version_ios");
        ...
        private void Search(string criteria)
        {
            ...
            {
                List<clsversion_ios> lstItemSearch = new List<clsversion_ios>();
                lstItemSearch = clsMetier.GetInstance().getAllClsversion_ios(criteria);
        ...
        {
            ((clsversion_ios)bdsrc.Current).User_modified = smartManage.Desktop.Properties.Settings.Default.UserConnected;
            ((clsversion_ios)bdsrc.Current).Date_modified = DateTime.Now;

            int record = materiel.update(((clsversion_ios)bdsrc.Current));
        ...
        private void Delete()
        {
            if (blnModifie)
            {
                ...
                {
                    record = materiel.delete(((clsversion_ios)bdsrc.Current));
        ...
        private void frmVersionIOS_Load(object sender, EventArgs e)
        {

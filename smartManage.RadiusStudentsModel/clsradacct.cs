...
namespace smartManage.RadiusStudentsModel
{
    public class clsradacct
    {
        ...
        {
            return clsMetier2.GetInstance().getAllClsradacct();
        }
        public List<clsradacct> listes(string criteria)
        {
            return clsMetier2.GetInstance().getAllClsradacct(criteria);
        }
        public int inserts()
        {
            return clsMetier2.GetInstance().insertClsradacct(this);
        }
        public int update(clsradacct varscls)
        {
            return clsMetier2.GetInstance().updateClsradacct(varscls);
        }
        public int update()
        {
            return clsMetier2.GetInstance().updateClsradacct(this);
        }
        public int delete(clsradacct varscls)
        {
            return clsMetier2.GetInstance().deleteClsradacct(varscls);
        }
        public int delete()
        {
            return clsMetier2.GetInstance().deleteClsradacct(this);
        }
        public int delete_all()
        {
            return clsMetier2.GetInstance().deleteClsradacct();
        }
